    ...
    <>
      <div className={styles.main}>
        ...
        <p>
          ...
          more. With its user-friendly interface and powerful search
          capabilities, CineSync makes it easy to find and stream the latest and
          greatest movies and TV shows from around the world.
        </p>
        <br />
        <p>
          One of the standout features of CineSync is its use of webRTC
          technology, which allows users to watch movies together anonymously
          and securely without having to reveal their personal information or
